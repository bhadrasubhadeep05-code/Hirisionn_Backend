...
const {createJob, getJobCardData, getJobData, deleteJobs, Applyjob, getJobAdmin, getApplicants, stateController, jobActiveToggel } = require('../controllers/job.controller');
